	...
	engine.Register(engine.NativeDrop{
		Manifest: core.Manifest{
			...
			Outputs: []core.Port{
				...
				{Port: "number", Label: "PR number", MIME: []string{"text/plain"}, Example: json.RawMessage(`"128"`)},
				{Port: "title", Label: "Title", MIME: []string{"text/plain"}, Example: json.RawMessage(`"Fold-down data face on step cards"`)},
				{Port: "body", Label: "Description", MIME: []string{"text/plain"}, Example: json.RawMessage(`"Adds Port.Example so a step can say what it produces before it runs."`)},
				{Port: "author", Label: "Author", MIME: []string{"text/plain"}, Example: json.RawMessage(`"klarre"`)},
				{Port: "head_ref", Label: "Source branch", MIME: []string{"text/plain"}, Example: json.RawMessage(`"feat/fold-down-data-face"`)},
				{Port: "base_ref", Label: "Target branch", MIME: []string{"text/plain"}, Example: json.RawMessage(`"master"`)},
				{Port: "html_url", Label: "PR link", MIME: []string{"text/plain"}, Example: json.RawMessage(`"https://github.com/dazyflow/dazyflow/pull/128"`)},
