		...
		Manifest: core.Manifest{
			...
			ParamsSchema: json.RawMessage(`{
				...
				"properties":{
					...
					"show_map":{"type":"boolean","default":true,"title":"Show map on card","description":"Show the interactive map on the step card. Turn off for a compact card — you can still pick in the inspector or drive it with the Place input."},
