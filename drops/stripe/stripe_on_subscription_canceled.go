...
func init() {
	engine.Register(engine.NativeDrop{
		Manifest: core.Manifest{
			...
			Outputs: []core.Port{
				{Port: "subscription_id", Label: "Subscription ID", MIME: []string{"text/plain"}, Example: json.RawMessage(`"sub_1QxPl2Fk9mNaB1cD"`)},
				{Port: "customer", Label: "Customer", MIME: []string{"text/plain"}, Example: json.RawMessage(`"cus_RkP2mNaB1cDeFg"`)},
				{Port: "plan", Label: "Plan", MIME: []string{"text/plain"}, Example: json.RawMessage(`"price_1QxPkzFk9mNaB1cD"`)},
				{Port: "ended_at", Label: "Ended at", MIME: []string{"text/plain"}, Example: json.RawMessage(`"2026-02-12T09:12:04Z"`)},
