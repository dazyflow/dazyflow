...
func init() {
	engine.Register(engine.NativeDrop{
		Manifest: core.Manifest{
			...
			Outputs: []core.Port{
				{Port: "invoice_id", Label: "Invoice ID", MIME: []string{"text/plain"}, Example: json.RawMessage(`"in_1QxPl2Fk9mNaB1cD"`)},
				{Port: "hosted_invoice_url", Label: "Invoice URL", MIME: []string{"text/plain"}, Example: json.RawMessage(`"https://invoice.stripe.com/i/acct_1Qx/test_YWNjd1"`)},
				{Port: "status", Label: "Status", MIME: []string{"text/plain"}, Example: json.RawMessage(`"open"`)},
				{Port: "meta", Label: "Details", MIME: []string{"application/json"},
					Example: json.RawMessage(`{"id":"in_1QxPl2Fk9mNaB1cD","status":"open","url":"https://invoice.stripe.com/i/acct_1Qx/test_YWNjd1","customer":"cus_RkP2mNaB1cDeFg","amount":24900,"currency":"sek","amount_display":"249.00 SEK"}`)},
			},
