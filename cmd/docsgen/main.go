...
func frontMatter(b *strings.Builder, title, icon string) {
	...
	b.WriteString("<!-- Generated by cmd/docsgen from drop manifests. Do not edit by hand. -->\n\n")
}

// groupBrand is the vendor mark shared by a group's drops (the first BrandLogo
// that's set). Empty for first-party building blocks, which fall back to a
// generic glyph in the docs.
