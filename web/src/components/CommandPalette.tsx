...
export function CommandPalette({
  ...
  const commands = useMemo<Command[]>(() => {
    const nav: Command[] = [
      ...
      { id: "nav:flows", label: t("common.flows"), icon: <Workflow size={ICON.md} />, group: "nav", keywords: "workflows automations flöden", run: () => go("/flows") },
      ...
      { id: "nav:usage", label: t("common.usage"), icon: <Gauge size={ICON.md} />, group: "nav", keywords: "billing quota metering användning fakturering", run: () => go("/usage") },
    ];
    ...
    if (canAdmin) {
      admin.push(
        ...
        { id: "admin:secrets", label: t("common.secrets"), icon: <Lock size={ICON.md} />, group: "admin", keywords: "api keys tokens credentials hemligheter nycklar", run: () => go("/admin/secrets") },
        ...
        { id: "admin:workspace", label: t("common.organization"), icon: <Building2 size={ICON.md} />, group: "admin", keywords: "organization limits quota name logo organisation gränser namn", run: () => go("/admin/workspace") },
