...
export function RevealSecretModal({ issued, onClose, }) {
    ...
    return (_jsx("div", { className: "settings-backdrop", children: _jsxs("div", { className: "settings-dialog", style: { maxWidth: 540 }, children: [_jsx("div", { className: "settings-head", children: _jsx("h2", { children: "Save this secret \u2014 it's shown once" }) }), _jsxs("div", { className: "settings-body", children: [_jsx("p", { className: "settings-help", children: "The bearer token below is the only chance to see it. Hazy Flow stores a salted hash; if you lose this string, revoke the key and issue a new one." }), _jsx("div", { className: "secret-reveal", children: issued.secret }), _jsxs("button", { onClick: copy, style: { marginTop: "var(--space-3)" }, children: [_jsx(Copy, { size: 12, style: { marginRight: 6, verticalAlign: -1 } }), copied ? "Copied" : "Copy to clipboard"] }), _jsxs("div", { className: "sf-field", style: { marginTop: "var(--space-4)" }, children: [_jsx("div", { className: "label-row", children: _jsx("label", { children: "Key ID" }) }), _jsx("input", { value: issued.id, disabled: true, style: { fontFamily: "var(--font-mono)" } })] })] }), _jsx("div", { className: "settings-foot", children: _jsx("button", { className: "primary", onClick: onClose, children: "I've saved it" }) })] }) }));
}
