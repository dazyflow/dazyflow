...
import { Menu, LogOut, Workflow, ShieldCheck, Activity, Inbox, ChevronDown, FolderTree, Building2, } from "lucide-react";
import { api } from "../api";
...
function WorkspaceSwitcher({ tenant, activeWorkspace, workspaces, onPick, hideTenantPrefix, }) {
    ...
    const label = hideTenantPrefix ? (_jsx("strong", { children: activeWorkspace || "(none)" })) : (_jsxs(_Fragment, { children: [tenant, "/", _jsx("strong", { children: activeWorkspace || "(none)" })] }));
    if (!multi) {
...
function TenantSwitcher({ tenants, activeTenant, onPick, }) {
    ...
    return (_jsxs("div", { className: "tenant-switcher", style: { position: "relative" }, children: [_jsxs("button", { type: "button", className: "ghost", onClick: () => setOpen((v) => !v), style: {
                    ...
                    fontSize: 13,
                    padding: "4px 10px",
                }, title: "Switch tenant", children: [_jsx(Building2, { size: 13 }), _jsx("strong", { children: activeTenant || "(pick tenant)" }), _jsx(ChevronDown, { size: 12 })] }), open && (_jsxs("div", { className: "workspace-pop", children: [_jsx("div", { className: "workspace-pop-head", children: "Tenants" }), tenants.map((t) => (_jsx("button", { type: "button", className: "workspace-pop-row" + (t === activeTenant ? " active" : ""), onClick: () => {
                            onPick(t);
                            setOpen(false);
                        }, children: t }, t)))] }))] }));
}
