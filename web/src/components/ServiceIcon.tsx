    ...
    glyph: {
      ...
      art: (
        <>
          <path
            fill="#003824"
            d="M774.4 302.8h243.3c17.6 0 27.1 9.5 27.1 27.1v129.8c0 17.5-9.4 26.9-27.1 26.9H774.4c-56.7 0-94.5 37.9-94.5 94.6v177h337.8c17.6 0 27.1 9.5 27.1 27V915c0 17.6-9.4 27.1-27.1 27.1H679.9v252.6c0 17.6-9.5 27.1-27.1 27.1H517.7c-17.6 0-27.1-9.4-27.1-27.1V586.6c0-168.9 114.9-283.9 283.8-283.9"
          />
          <path
            fill="#007533"
          ...
          <path
            fill="#00db33"
            d="M234 350.8c-12.5 0-25.2-4.3-35.2-13.2-22.2-19.5-24.3-53.2-4.8-75.3C380.3 50.5 667.6-42.9 943.4 18.6c28.8 6.4 46.9 34.9 40.5 63.7-6.4 28.7-34.9 46.8-63.7 40.4-237.9-53-485.5 27.6-646.3 210-10.5 11.9-25.2 18.1-39.9 18.1"
          />
        </>
      ),
    },
