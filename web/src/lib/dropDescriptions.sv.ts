...
export const SV_DESCRIPTIONS: DescriptionMap = {
  ...
  await_approval: {
    en: "da0afb23",
    sv: "Pausa flödet tills någon godkänner. Fyll i \"Mejla de här personerna\" så mejlar Dazyflow dem godkännandelänken när flödet kommer hit, och berättar utfallet när någon har beslutat; lämnar du det tomt mejlas alla i organisationen som kan godkänna i stället. Vill du dessutom avisera på något annat sätt lägger du det här steget FÖRE steget som meddelar personen — du får en Godkännandelänk (utgången `pending_url`) att lägga in i meddelandet (t.ex. ntfy:s 'Länk att öppna' eller en e-posttext). Alla som har länken kan godkänna eller avslå — det går inte att rikta den till en enskild person, så skicka den bara till dem som ska besluta; flödet registrerar vem som klickade på utgången Godkännare. Personen trycker på länken för att godkänna eller avslå; först då fortsätter resten av flödet. När flödet återupptas kommer indatat Värde ut på porten Godkänt eller Avslaget beroende på beslutet (koppla var och en till sin fortsättning — inget separat Förgrening-steg behövs), tillsammans med den Godkännare som beslutade och personens Kommentar.",
  },
  base64: {
    en: "dae52265",
