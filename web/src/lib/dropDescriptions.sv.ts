...
export const SV_DESCRIPTIONS: DescriptionMap = {
  ...
  await_approval: {
    en: "6ea0bdaa",
    sv: "Pausa flödet tills någon godkänner. Koppla in i den här ordningen: lägg det här steget FÖRE steget som meddelar personen — du får en Godkännandelänk (utgången `pending_url`) att lägga in i meddelandet (t.ex. ntfy:s 'Länk att öppna' eller en e-posttext). Alla som har länken kan godkänna eller avslå — det går inte att rikta den till en enskild person, så skicka den bara till dem som ska besluta; flödet registrerar vem som klickade på utgången Godkännare. Personen trycker på länken för att godkänna eller avslå; först då fortsätter resten av flödet. När flödet återupptas kommer indatat Värde ut på porten Godkänt eller Avslaget beroende på beslutet (koppla var och en till sin fortsättning — inget separat Förgrening-steg behövs), tillsammans med den Godkännare som beslutade och personens Kommentar.",
  },
  base64: {
    en: "e3a1ce30",
