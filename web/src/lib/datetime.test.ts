...
describe("formatRelative", () => {
  ...
  // real key wiring without pulling in the i18n runtime.
  ...
  it("renders minutes, hours, and days", () => {
    expect(formatRelative("2026-06-23T11:55:00Z", t, now)).toBe("5m ago");
    expect(formatRelative("2026-06-23T09:00:00Z", t, now)).toBe("3h ago");
    expect(formatRelative("2026-06-21T12:00:00Z", t, now)).toBe("2d ago");
  });
