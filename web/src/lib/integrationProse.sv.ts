...
export const SV_INTEGRATION_PROSE: DescriptionMap = {
  ...
  "46elks.technical_notes": {
    en: "592f8a23",
    sv: "Autentiseras med ditt 46elks-API-användarnamn och lösenord (HTTP Basic), som anges en gång som 46elks-anslutningen på den här sidan (lagras krypterat som conn.46elks.*) och matas in vid körning — inga uppgifter på noden eller i flödet. Skickar en formulärkodad POST till 46elks ändpunkt /a1/sms. 'Från' är antingen E.164 (går att svara på) eller ett alfanumeriskt avsändar-ID (max 11 tecken, måste innehålla en bokstav, går inte att svara på). 46elks har ingen idempotensnyckel, så droppen gör aldrig automatiska omförsök och motorn rensar dubbletter i återupptagna körningar — ett nytt utskick skulle faktureras dubbelt.",
  },
  "chatgpt.description": {
    en: "c65b2822",
  ...
  "chatgpt.technical_notes": {
    en: "79e6a85c",
    sv: "OpenAI:s Chat Completions API, autentiserat med API-nyckeln som är satt på den här anslutningen — flödena hämtar den automatiskt, ingen nyckel på noden. De strukturerade dropparna (Extrahera fält, Klassificera) använder OpenAI:s function tool-calls.",
  },
  "claude.description": {
    en: "d4d74480",
  ...
  "claude.technical_notes": {
    en: "5f449725",
    sv: "Autentiseras med API-nyckeln som är satt på den här anslutningen — flödena hämtar den automatiskt, ingen nyckel på noden. För lokal utveckling utan nyckel dirigerar flaggan dzd --claude-cli anropen genom en lokal `claude -p`-CLI plus en MCP-server, så att flöden kan köra chattvägen mot din redan inloggade CLI.",
  },
  ...
  "fortnox.technical_notes": {
    en: "78810e8d",
    sv: "Fortnox OAuth 2.0 (authorize hos apps.fortnox.se/oauth-v1) med scope per resurs — customer, invoice och companyinformation täcker de droppar som finns. Token-ändpunkten använder client_secret_basic (uppgifterna i en HTTP Basic-rubrik), och refresh-tokens roterar vid varje förnyelse; daemonen sparar den roterade token och förnyar vid utgång, så långlivade flöden fortsätter fungera — men ett konto som stått stilla längre än Fortnox fönster för refresh-tokens (~31 dagar) måste anslutas om. Anrop och svar använder Fortnox singulara PascalCase-hölje ({\"Customer\":…}, {\"Invoice\":…}). Fortnox har ingen idempotensnyckel, så skapa-dropparna gör inga automatiska omförsök (ett omförsök skulle ge dubbletter); och inga webhooks, så 'utlös vid betald faktura' byggs som Schema → Lista fakturor (filter=fullypaid) → För varje → dubblettrensning på DocumentNumber.",
  },
  "git.description": {
    en: "856b77cd",
    sv: "Klona repon och checka ut grenar inne i din arbetsyta. Ta det när ett flöde behöver granska källkod, hämta mallar från ett känt repo, eller lägga upp filer innan en annan drop arbetar på dem.",
  },
  "git.technical_notes": {
    en: "2959c2a2",
  ...
  "gmail.description": {
    en: "89fe3c02",
    sv: "Skicka mejl, sök i din inkorg och läs hela meddelandetexter. Det klassiska användningsfallet: reagera på inkommande mejl när de kommer — kombinera sök-droppen med en pollningstrigger, så minns flödet vilka meddelanden det redan bearbetat och gör inte om samma arbete.",
  },
  ...
  "google-forms.description": {
    en: "25a4c1cd",
    sv: "Starta ett flöde när ett Google-formulär får nya svar, där varje svar har frågans rubrik som nyckel — koppla det direkt till ett tillägg i Sheets för att logga inskickade svar, eller till vilken drop som helst som tar poster.",
  },
  ...
  "mysql.technical_notes": {
    en: "6ec7b81c",
    sv: "Delar kontraktet med rader + rubriker med Sheets-, Excel- och Postgres-dropparna, så samma ETL-flöde kan riktas mot MySQL med en nodändring. Anslutningspool med *sql.DB och lat utrensning av inaktiva anslutningar. Upsert-droppen rapporterar antal infogade och uppdaterade separat via ROW_COUNT()-semantik, så senare aviseringar kan säga 'X nya + Y uppdaterade' i stället för en enda summa.",
  },
  "notion.description": {
    en: "d608ef07",
  ...
  "smhi.description": {
    en: "fda5a4d2",
    sv: "Kostnadsfritt nordiskt väder från Sveriges meteorologiska institut — inget konto och ingen API-nyckel. Ge SMHI Väder-dropparna en koordinat (välj den med en Plats-drop) och få aktuellt väderläge eller en flerdygnsprognos för vilken punkt som helst i Norden och området omkring, i metriska enheter.",
  },
  ...
  "twilio.technical_notes": {
    en: "3d0c666b",
    sv: "Autentiseras med ditt Twilio Account SID och Auth Token, som anges en gång som Twilio-anslutningen på den här sidan (lagras krypterat som conn.twilio.*) och matas in vid körning — inga uppgifter på noden eller i flödet. Skickar via Twilios Messages API; 'Från' måste vara ett av dina Twilio-nummer i E.164 (+15551234567), eller så anger du ett Messaging Service SID (MG…) i stället.",
  },
  "webhook.description": {
    en: "88c2043c",
