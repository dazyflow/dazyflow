...
export const SV_FIELD_TITLES: Record<string, string> = {
  ...
  "Include trashed": "Ta med papperskorgen",
  ...
  "Public hosted form": "Publikt hostat formulär",
  "Quantity": "Antal",
  "Query": "Fråga",
...
export const SV_FIELD_HELP: Record<string, string> = {
  ...
  "Field names the hosted form collects. Defaults to name, email, message.": "Fältnamnen som det hostade formuläret samlar in. Standard är name, email, message.",
  ...
  "Heading shown on the hosted form. Defaults to the flow's name.": "Rubrik som visas på det hostade formuläret. Standard är flödets namn.",
