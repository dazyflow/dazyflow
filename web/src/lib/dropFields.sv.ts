...
export const SV_FIELD_HELP: Record<string, string> = {
  ...
  "Comma-separated column names in priority order; earlier names win ties. Prefix a name with '-' for descending. E.g. \"revenue,-created_at\".": "Kommaseparerade kolumnnamn i prioritetsordning; tidigare namn avgör lika fall. Sätt '-' före ett namn för fallande ordning. T.ex. \"revenue,-created_at\".",
  "Comma-separated email addresses to notify when the flow reaches this step, and again once someone decides. Leave blank to email everyone in the organization who can approve (editors and admins). The email carries the same Approval link the pending_url output does — anyone who opens it can decide, so list only the people who should.": "Kommaseparerade e-postadresser som ska aviseras när flödet når det här steget, och igen när någon har beslutat. Lämna tomt för att mejla alla i organisationen som kan godkänna (redigerare och administratörer). Mejlet innehåller samma godkännandelänk som utgången pending_url — alla som öppnar den kan besluta, så ange bara de personer som ska göra det.",
  ...
  "Which columns to include, in order. Leave empty to use every column the data has, in its natural order. The inspector's drag-to-reorder editor writes this for you.": "Vilka kolumner som ska tas med, i ordning. Lämna tomt för att använda alla kolumner datat har, i sin naturliga ordning. Inspektorns dra-och-släpp-redigerare skriver detta för dig.",
