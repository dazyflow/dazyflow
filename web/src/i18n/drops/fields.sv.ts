...
export const SV_FIELD_TITLES: Record<string, string> = {
  ...
  "Move to weekday": "Flytta till veckodag",
...
export const SV_FIELD_HELP: Record<string, string> = {
  ...
  "Jump forward to the next named day — the coming Monday, say — before the offset is applied, so Monday with an offset of \"1d\" gives Tuesday. Today counts as a match, so on a Monday \"Monday\" means today. For the CURRENT week's Monday rather than the next one, add an offset of \"-7d\". Empty leaves the day alone.": "Hoppa fram till nästa namngivna dag — nu på måndag, till exempel — innan förskjutningen tillämpas, så att måndag med förskjutningen \"1d\" ger tisdag. I dag räknas som en träff, så på en måndag betyder \"Monday\" i dag. Vill du ha DEN HÄR veckans måndag i stället för nästa lägger du till förskjutningen \"-7d\". Tomt lämnar dagen som den är.",
...
export const SV_ENUM_LABELS: Record<string, string> = {
  ...
  "Custom…": "Eget…",
  // Date & time: the weekday dropdown. The tokens a custom format uses stay
  // English (they are what you type); these are read.
  Monday: "Måndag",
  Tuesday: "Tisdag",
  Wednesday: "Onsdag",
  Thursday: "Torsdag",
