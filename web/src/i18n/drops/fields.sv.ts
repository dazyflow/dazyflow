...
export const SV_FIELD_TITLES: Record<string, string> = {
  ...
  "Only the last N days": "Bara de senaste N dagarna",
  ...
  "Suffix for repeated column names": "Ändelse för kolumnnamn som återkommer",
...
export const SV_ENUM_LABELS: Record<string, string> = {
  ...
  "Time, 24-hour (14:05:09)": "Tid, 24-timmars (14:05:09)",
  "Time, 12-hour (2:05:09 PM)": "Tid, 12-timmars (2:05:09 PM)",
  "Weekday (Thursday)": "Veckodag (Thursday)",
  "Weekday, short (Thu)": "Veckodag, kort (Thu)",
...
export const SV_CONNECTION_TEXT: Record<string, string> = {
  ...
  "known_hosts entry": "known_hosts-rad",
