...
export const SV_SUBTITLES: Record<string, string> = {
  ...
  "When a file lands": "När en fil landar",
  "Delete file": "Ta bort fil",
  "Move file": "Flytta fil",
  "Sync folder": "Synka mapp",
  ...
  "Add or update rows": "Lägg till eller uppdatera rader",
  "When an event is announced": "När ett evenemang annonseras",
...
export const SV_PORTS: Record<string, string> = {
  ...
  "Files moved": "Flyttade filer",
  "Moved": "Flyttade",
  "Already in step": "Redan i takt",
  "New rows": "Nya rader",
  ...
  "Captured amount (cents/öre)": "Debiterat belopp (cent/öre)",
  "Match 1": "Träff 1",
  "Match 2": "Träff 2",
  "Match 3": "Träff 3",
  "Match 4": "Träff 4",
  ...
  "New responses": "Nya svar",
  "Next cursor": "Nästa markör",
  No: "Nej",
  Number: "Tal",
  "On change": "Vid ändring",
  "On this page": "På den här sidan",
  "Order ID": "Order-ID",
  "Order amount (cents/öre)": "Orderbelopp (cent/öre)",
  ...
  "Refunded amount (cents/öre)": "Återbetalat belopp (cent/öre)",
  Rejected: "Avslaget",
  ...
  To: "Till",
  Topic: "Ämne (topic)",
  "Total matches": "Totalt antal träffar",
