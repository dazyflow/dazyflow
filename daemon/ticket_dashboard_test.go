...
// Pins the Phase 3 boundaries in both directions: the customer never sees
// which staff member owns or answered their ticket, the customer may
// close/reopen but not declare "resolved", and neither a plain member nor a
// platform admin can work the cross-org queue.
